...
`),Ls={emoji:"Emoji_emoji__iKc1G"};R(`.Emoji_emoji__iKc1G {
  background: transparent;
  border: none;
  border-radius: 15px;
  cursor: pointer;
...
`),Ms={emojiContainer:"EmojiContainer_emojiContainer__4SPb5"};R(`.EmojiContainer_emojiContainer__4SPb5 {
  display: grid;
