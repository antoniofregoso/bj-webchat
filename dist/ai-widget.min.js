...
`),Ls={emoji:"Emoji_emoji__iKc1G"};M(`.Emoji_emoji__iKc1G {
  background: transparent;
  border: none;
  border-radius: 15px;
  cursor: pointer;
...
`),Sn={error:"ErrorMessage_error__7I7y1",icon:"ErrorMessage_icon__4---V","appear-grow":"ErrorMessage_appear-grow__oBenJ",title:"ErrorMessage_title__shDDT",appear:"ErrorMessage_appear__kry-R"};M(`@keyframes ErrorMessage_appear__kry-R {
  0% {
    opacity: 0;
  }
  100% {
...
}`);var Ne=class extends k{constructor({message:t,icon:i="warning",template:n=Ns,className:r}){super({template:n,classes:Sn}),this.message=t,this.icon=i,this.className=r}renderSync(){let t=[Sn.error,this.className].join(" ").trim();return super.renderSync({message:this.message,icon:this.icon,classList:t})}},Ds="DataError_dataError__jyJ0H";M(`.DataError_dataError__jyJ0H [data-icon] {
  opacity: 0.8;
...
`),di=class extends Ne{constructor({message:t}){super({message:t,template:$s,className:Ds})}initialize(){this.uiElements={retryButton:"button"},this.uiEvents=[k.childEvent("retryButton","click",this.onRetry)],super.initialize()}onRetry(){return b(this,void 0,void 0,function*(){this.emojiData?yield this.emojiData.delete():yield this.options.dataStore.deleteDatabase(this.options.locale),this.events.emit("reinitialize");let t=yield zn(this.options.locale,this.options.dataStore,this.options.messages,this.options.emojiData,this.emojiData);this.viewFactory.setEmojiData(t),this.events.emit("data:ready",t)})}},Me={preview:"Preview_preview__HcFH6",previewEmoji:"Preview_previewEmoji__vjUki",previewName:"Preview_previewName__C79nL",tagList:"Preview_tagList__DielP",tag:"Preview_tag__aUSTM"};M(`.Preview_preview__HcFH6 {
...
`),Pn={variantOverlay:"VariantPopup_variantOverlay__gGwue",variantPopup:"VariantPopup_variantPopup__c2pHF"};M(`.VariantPopup_variantOverlay__gGwue {
...
`),rt={categoryButtons:"CategoryTabs_categoryButtons__dJVp-",categoryButton:"CategoryTabs_categoryButton__AsR9b",categoryTab:"CategoryTabs_categoryTab__fAgQT",categoryTabActive:"CategoryTabs_categoryTabActive__691be"};M(`.CategoryTabs_categoryButtons__dJVp- {
  --tab-size-ratio: 1.55;
  --tab-padding: 0.5em;
...
`),vi=class extends k{constructor({categories:t}){super({template:Ys,classes:rt}),this.activeCategoryIndex=0,this.categories=t}initialize(){this.keyBindings={ArrowLeft:this.stepSelectedTab(-1),ArrowRight:this.stepSelectedTab(1)},super.initialize()}renderSync(){return this.tabViews=this.categories.map(t=>this.viewFactory.create(gi,{category:t,icon:st[t.key]})),super.renderSync({tabs:this.tabViews.map(t=>t.renderSync())}),this.currentTabView.setActive(!0),this.el}get currentCategory(){return this.categories[this.activeCategoryIndex]}get currentTabView(){return this.tabViews[this.activeCategoryIndex]}setActiveTab(t,i=!0,n=!0){if(t===this.activeCategoryIndex)return;let r=this.currentTabView,o=this.tabViews[t];r.setActive(!1,i),o.setActive(!0,i,n),this.activeCategoryIndex=t}getTargetCategory(t){return t<0?this.categories.length-1:t>=this.categories.length?0:t}stepSelectedTab(t){return()=>{let i=this.activeCategoryIndex+t;this.setActiveTab(this.getTargetCategory(i))}}},Gs=[{version:15,emoji:String.fromCodePoint(129768)},{version:14,emoji:String.fromCodePoint(128733)},{version:13,emoji:String.fromCodePoint(129729)},{version:12,emoji:String.fromCodePoint(129449)},{version:11,emoji:String.fromCodePoint(129463)},{version:5,emoji:String.fromCodePoint(129322)},{version:4,emoji:String.fromCodePoint(9877)},{version:3,emoji:String.fromCodePoint(129314)},{version:2,emoji:String.fromCodePoint(128488)},{version:1,emoji:String.fromCodePoint(128512)}];function Js(){var e;let t=Gs.find(i=>function(n){let r=document.createElement("canvas").getContext("2d");if(r)return r.textBaseline="top",r.font="32px Arial",r.fillText(n,0,0),r.getImageData(16,16,1,1).data[0]!==0}(i.emoji));return(e=t?.version)!==null&&e!==void 0?e:1}function qt(e,t){return Array.from({length:e},()=>t).join("")}function Zs(e){let{emojiCount:t,classes:i,theme:n,className:r}=e;return`
  ...
  `:"")(e)}
    ...
    <div class="${s.previewSkeleton}">
      ...
      <ul class="${s.tagList}">
        ${qt(3,`<li class="${s.placeholder} ${s.tag}"></li>`)}
      </ul>
    </div>
  `:"")(e)}
    </div>
